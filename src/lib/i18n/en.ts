...
export const en = {
  ...
  accounts: {
    ...
    namePlaceholder: 'e.g. BofA',
    kindBank: 'Bank',
    kindCash: 'Cash',
    last4Label: 'Last 4 digits',
    create: 'Create',
    cancel: 'Cancel',
    moveTitle: 'Move records from {name}',
    moveAll: 'Move everything',
    movePick: 'Pick records',
    moveTo: 'Move to',
    moveConfirm: 'Move',
    moving: 'Moving…',
    checking: 'Checking this account…',
    usageFailed: "Couldn't check that account.",
    usageOne: 'This account has 1 record.',
    usageOther: 'This account has {count} records.',
    rulesStayBehind: 'Scheduled payments ({count}) only move with "Move everything".',
    noDestinations: 'There is no other active account to move records into. Create one first.',
    noDescription: '(no description)',
    preferLabel: 'Use {name} by default',
    unpreferLabel: 'Stop using {name} by default',
    preferred: 'Default',
    hibernateLabel: 'Hibernate {name}',
    wakeLabel: 'Wake {name}',
  ...
  transfer: {
    title: 'Transfer',
    blurb: 'Move money between your accounts. Your total stays the same — only where it sits changes. Transfers never appear in Reports.',
    from: 'From',
    to: 'To',
    amount: 'Amount',
    date: 'Date',
  ...
  addTxn: {
    ...
    accountsFailed: "Couldn't load your accounts.",
  ...
  txnDetail: {
    ...
    closedAccountLocked: 'This account is closed. The amount and account are locked; other details can still be edited.',
  ...
  serverErrors: {
    ...
    'notFound.account': 'That account no longer exists.',
    'validation.accountNameRequired': 'An account needs a name.',
    'validation.accountNameTooLong': 'That account name is too long.',
    'validation.accountNameDuplicate': 'You already have an account with that name.',
    'validation.accountKindInvalid': 'Choose an account type.',
    'validation.accountLast4Invalid': 'Enter the last 4 digits of the account number.',
    'validation.accountOpeningNumber': 'Opening balance must be a number.',
    'validation.accountDefaultCannotClose': 'The default Checking and Cash accounts cannot be closed.',
    'validation.accountAlreadyClosed': 'That account is already closed.',
    'validation.accountBalanceNotZero': 'An account must have a zero balance before it can be closed.',
    'validation.hibernatedNoDelete': 'This account is hibernated. Wake it first to delete transactions.',
    'validation.accountNotHibernated': 'That account is not hibernated.',
    'validation.moveSameAccount': 'Choose a different destination account.',
    'validation.transferSameAccount': 'Choose two different accounts.',
    'validation.transferAmountPositive': 'Transfer amount must be greater than zero.',
    'validation.transferInactiveAccount': 'Both accounts must be active to transfer between them.',
    'validation.preferredMustBeActive': 'A hibernated account cannot be the preferred one.',
    'validation.moveDestinationInactive': 'Records can only be moved into an active account.',
    'validation.accountNotEmpty': 'This account still has records. Move them to another account first.',
    'validation.closedAccountLocked': 'The amount and account of a transaction on a closed account cannot be changed.',
    'validation.accountHasRules': 'This account still has scheduled payments. Delete or move them first.',
